...
#define PEE  (1 << 16) // Parity Error
#define FEE  (1 << 18) // Frame Errot
#define RFOE (1 << 26) // RxFifo Overflow
#define RFUE (1 << 27) // RxFifo Underflow
#define RFLE (1 << 28) // RxFifo Level
#define TFOE (1 << 30) // TxFifo Overflow
